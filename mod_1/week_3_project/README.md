...
12/30 Monday - Official Project Assignment 
 - schedule Monday check in with instructors
 
12/31 Tuesday - Check in with instructors 
...
1/2 Thursday Morning - Demo presentation with feedback from instructors 
 - have deck completed
 - have polished version of jupyter notebook completed
 
1/2 Thursday Afternoon 
